#ifndef SSD1306_DRIVER_j0ono0_h
#define SSD1306_DRIVER_j0ono0_h
    ...
    static const uint8_t PROGMEM ssd1306_initialization_sequence[] =
    {
    ...
    static const int img_hello_length = 1024;

    static const uint8_t PROGMEM img_hello[] = {
